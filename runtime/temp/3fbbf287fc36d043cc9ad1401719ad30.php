<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:64:"E:\www\ming\public/../application/admin\view\index\newsedit.html";i:1528877769;s:44:"E:\www\ming\application\admin\view\page.html";i:1528825955;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
	...
	<form class="layui-form" action="" method="post">
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<input type="text" value=" <?php echo $user['cname']; ?>" name="cname" class="layui-input newsName" lay-verify="required" placeholder="请输入文章标题">
		...
		<div class="layui-form-item">
			<div class="layui-inline">
				...
				<div class="layui-input-block">
					<input type="checkbox" name="tuijian" value="1" class="tuijian" title="推荐">
					<input type="checkbox" name="shenhe" value="2" class="newsStatus" title="审核">
					<input type="checkbox" name="show" value="3" class="isShow" title="展示">
				</div>
			</div>
			<div class="layui-inline">		
				...
				<div class="layui-input-inline">
					<input type="text" value="<?php echo $user['address']; ?>" name="address" class="layui-input newsAuthor" lay-verify="required" placeholder="请输入文章作者">
			...
			<div class="layui-inline">
				...
				<div class="layui-input-inline">
					<select name="state" class="newsLook" lay-filter="browseLook">
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<input type="text" class="layui-input" name="email" placeholder="请输入文章关键字">
			</div>
		</div>
		<div class="layui-form-item">
...
<?php echo $user['miaoshu']; ?>
		...
		<div class="layui-form-item">
			<div class="layui-input-block">
				<button class="layui-btn" lay-submit="" >修改文章</button>
	...
	<script type="text/javascript" src="__STARTC__/js/newsAdd.js"></script>
</body>
</html>

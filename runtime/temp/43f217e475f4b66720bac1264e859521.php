<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:62:"E:\www\ming\public/../application/index\view\index\index4.html";i:1528606615;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
		<meta charset="utf-8">
		...
		<script src="/static/index/js/TMForm.js"></script>
		...
		<link rel="stylesheet" media="screen" href="/static/index//static/index/css/ie.css">
		<![endif]-->
	</head>
	<body id="top">
<!--==============================header=================================-->
				...
				<div class="grid_12">
					<nav class="horizontal-nav full-width horizontalNav-notprocessed">
						<ul class="sf-menu">
							...
							<li class="current"><a href="index4.html">Contacts</a></li>
						</ul>
					</nav>
					<div class="clear"></div>
				</div>
							...
							<div class="inner maxheight">
								...
								<div class="map">
									...
									<div class="grid_4 alpha">
										...
										<p>All <span class="col1"><a href=" http://www.xwcms.net" rel="nofollow">premium templates</a></span> from our collection come with 24/7 support, while freebies go without it.</p>
										They are easily customizable, but if you have any problems with it, ask guys from <span class="col1"><a href="http://www.templatetuning.com/" rel="nofollow">Template Tuning</a></span> to help you. Notice that it’s a paid service.
									</div>
									<div class="fright">
										<h4>Feedback</h4>
										<form id="form">
